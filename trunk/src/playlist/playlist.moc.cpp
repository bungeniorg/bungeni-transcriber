...
static const char qt_meta_stringdata_PlaylistWidget[] = {
    ...
    "play(QModelIndex)\0playSlot(QModelIndex)\0"
};
...
int PlaylistWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: play((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 2: playSlot((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
...
// SIGNAL 1
void PlaylistWidget::play(const QModelIndex & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
