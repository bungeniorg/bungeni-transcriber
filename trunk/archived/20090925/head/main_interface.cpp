...
void MainInterface::setVLCWindowsTitle( QString aTitle )
{
    if( aTitle.isEmpty() )
    {
        ...
        setWindowTitle( qtr( "Bungeni Transcribe" ) );
    }
    else
    {
        //setWindowTitle( aTitle + " - " + qtr( "VLC media player" ) );
        setWindowTitle( aTitle + " - " + qtr( "Bungeni Transcribe" ) );
    }
}
...
rhs_layout = new QVBoxLayout(rhs);
lhs_layout = new QVBoxLayout(lhs);
rhs_layout->setAlignment(Qt::AlignBottom);
mainLayout->addWidget( lhs, 0, 0);
mainLayout->addWidget( rhs, 0, 1);
    
  if( videoEmbeddedFlag )
    {
        videoWidget = new VideoWidget( p_intf );
        lhs_layout->addWidget( videoWidget );
    }
...
//transcribeWidget = TranscribeWidget::getInstance(p_intf);
transcribeWidget = TranscribeWidget::getInstance(p_intf);
rhs_layout->addWidget( transcribeWidget);
...
{
    int nwidth  = controls->sizeHint().width()*2;
...
void MainInterface::togglePlaylist()
{
    ...
    if( !playlistWidget )
    {
        ...
        CONNECT(playlistWidget, play( const QModelIndex& ), TranscribeWidget::getInstance(p_intf), playItem( const QModelIndex& ));
        i_pl_dock = PL_RIGHT;
/*        i_pl_dock = (pl_dock_e)getSettings()
        ...
        {
            lhs_layout->addWidget( playlistWidget, 4, 0 );
        }
...
void MainInterface::createSystray()
{
    ...
    sysTray->setToolTip( qtr( "Bungeni Transcribe" ));
    //systrayMenu = new QMenu( qtr( "VLC media player" ), this );
    systrayMenu = new QMenu( qtr( "Bungeni Transcribe" ), this );
                                    ...
                                    QSystemTrayIcon::ActivationReason reason )
{
    switch( reason )
    {
        ...
        case QSystemTrayIcon::MiddleClick:
            ...
            */
            sysTray->showMessage( qtr( "Bungeni Transcribe" ),
                    qtr( "Control menu for the player" ),
                    QSystemTrayIcon::Information, 3000 );
            break;
    }
...
void MainInterface::updateSystrayTooltipName( QString name )
{
    ...
    else
    {
        ...
        if( notificationEnabled && ( isHidden() || isMinimized() ) )
        {
            ...
            */
            sysTray->showMessage( qtr( "Bungeni Transcribe" ), name,
                    QSystemTrayIcon::NoIcon, 3000 );
        }
    }
}
