...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Tue Sep 29 17:44:04 2009
...
$(TARGET): src/ui/ui_transcribe.h src/ui/ui_inplace_editor.h src/ui/ui_uploadProgress.h src/ui/ui_controls.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/transcribeWidget.hpp src/controlsWidget.hpp src/ListViewDelegate.hpp src/customTextEdit.hpp src/inplaceEditor.hpp src/network/formpost.hpp src/qxtspanslider/qxtspanslider_p.h src/qxtspanslider/qxtspanslider.h .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/resources.qrc .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/transcribeWidget.cpp src/controlsWidget.cpp src/main.cpp src/ListViewDelegate.cpp src/customTextEdit.cpp src/inplaceEditor.cpp src/network/formpost.cpp src/qxtspanslider/qxtspanslider.cpp .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/ui/transcribe.ui src/ui/inplace_editor.ui src/ui/uploadProgress.ui src/ui/controls.ui .tmp/transcribe1.0.0/ && (cd `dirname .tmp/transcribe1.0.0` && $(TAR) transcribe1.0.0.tar transcribe1.0.0 && $(COMPRESS) transcribe1.0.0.tar) && $(MOVE) `dirname .tmp/transcribe1.0.0`/transcribe1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/transcribe1.0.0
...
compiler_moc_header_make_all: moc_transcribeWidget.cpp moc_controlsWidget.cpp moc_ListViewDelegate.cpp moc_customTextEdit.cpp moc_inplaceEditor.cpp moc_formpost.cpp moc_qxtspanslider_p.cpp moc_qxtspanslider.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_transcribeWidget.cpp moc_controlsWidget.cpp moc_ListViewDelegate.cpp moc_customTextEdit.cpp moc_inplaceEditor.cpp moc_formpost.cpp moc_qxtspanslider_p.cpp moc_qxtspanslider.cpp
...
compiler_uic_make_all: src/ui/ui_transcribe.h src/ui/ui_inplace_editor.h src/ui/ui_uploadProgress.h src/ui/ui_controls.h
compiler_uic_clean:
	-$(DEL_FILE) src/ui/ui_transcribe.h src/ui/ui_inplace_editor.h src/ui/ui_uploadProgress.h src/ui/ui_controls.h
