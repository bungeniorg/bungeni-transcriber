...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Mon Oct 5 10:19:22 2009
...
SOURCES       = src/transcribeWidget.cpp \
		...
		src/about.cpp moc_transcribeWidget.cpp \
...
$(TARGET): src/ui/ui_transcribe.h src/ui/ui_inplace_editor.h src/ui/ui_uploadProgress.h src/ui/ui_controls.h src/ui/ui_addToPlaylist.h src/ui/ui_about.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/transcribeWidget.hpp src/controlsWidget.hpp src/listViewDelegate.hpp src/customTextEdit.hpp src/inplaceEditor.hpp src/playlistWidget.hpp src/network/formpost.hpp src/addToPlaylistWidget.hpp src/qxtspanslider/qxtspanslider_p.h src/qxtspanslider/qxtspanslider.h src/about.hpp .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/resources.qrc .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/transcribeWidget.cpp src/controlsWidget.cpp src/main.cpp src/listViewDelegate.cpp src/customTextEdit.cpp src/inplaceEditor.cpp src/playlistWidget.cpp src/network/formpost.cpp src/addToPlaylistWidget.cpp src/qxtspanslider/qxtspanslider.cpp src/about.cpp .tmp/transcribe1.0.0/ && $(COPY_FILE) --parents src/ui/transcribe.ui src/ui/inplace_editor.ui src/ui/uploadProgress.ui src/ui/controls.ui src/ui/addToPlaylist.ui src/ui/about.ui .tmp/transcribe1.0.0/ && (cd `dirname .tmp/transcribe1.0.0` && $(TAR) transcribe1.0.0.tar transcribe1.0.0 && $(COMPRESS) transcribe1.0.0.tar) && $(MOVE) `dirname .tmp/transcribe1.0.0`/transcribe1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/transcribe1.0.0
...
compiler_moc_header_make_all: moc_transcribeWidget.cpp moc_controlsWidget.cpp moc_listViewDelegate.cpp moc_customTextEdit.cpp moc_inplaceEditor.cpp moc_playlistWidget.cpp moc_formpost.cpp moc_addToPlaylistWidget.cpp moc_qxtspanslider_p.cpp moc_qxtspanslider.cpp moc_about.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_transcribeWidget.cpp moc_controlsWidget.cpp moc_listViewDelegate.cpp moc_customTextEdit.cpp moc_inplaceEditor.cpp moc_playlistWidget.cpp moc_formpost.cpp moc_addToPlaylistWidget.cpp moc_qxtspanslider_p.cpp moc_qxtspanslider.cpp moc_about.cpp
...
compiler_uic_make_all: src/ui/ui_transcribe.h src/ui/ui_inplace_editor.h src/ui/ui_uploadProgress.h src/ui/ui_controls.h src/ui/ui_addToPlaylist.h src/ui/ui_about.h
compiler_uic_clean:
	-$(DEL_FILE) src/ui/ui_transcribe.h src/ui/ui_inplace_editor.h src/ui/ui_uploadProgress.h src/ui/ui_controls.h src/ui/ui_addToPlaylist.h src/ui/ui_about.h
